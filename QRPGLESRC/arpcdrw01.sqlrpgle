...
Dcl-S HeaderExists Ind Inz(*Off);
...
// Load all detail records into array
LoadAllRecords();
...
Dcl-Proc LoadHeader;
  ...
  Exec SQL
    ...
    Into :HeaderDS.effBegin, :HeaderDS.effEnd, :HeaderDS.drawDesc,
  ...
  If SQLSTATE = '00000';
    ...
    HEFFEND = %Char(HeaderDS.effEnd);
    HDESC = %Trim(HeaderDS.drawDesc);
    HCHGUSER = HeaderDS.chgUser;
