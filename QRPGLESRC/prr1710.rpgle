...
¢D   F*V JJF   3194 032626 JJF Skip omitted items from LISTPRBKP table         *
     F*M ----------------------------------------------------------------------*
...
¢B   C                   ENDSR
     ...
     C     Write_Item    BEGSR
¢D   /free
¢D    // Check if item is omitted in LISTPRBKP table
¢D    exec sql
¢D      select count(*)
¢D      into :Skip_Item
¢D      from LISTPRBKP
¢D      where COMPANY = :BM_ARNO15
¢D        and BRANCH = :PR_ARNO16
¢D        and CUSTOMER = :wkcust
¢D        and ITEM = :IM_IVNO07
¢D        and STATUS = 'X';
¢D    // If item is omitted, exit subroutine without writing
¢D    if Skip_Item > 0;
¢D      leavesr;
¢D    endif;
¢D   /end-free
