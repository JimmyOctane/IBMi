...
¢C    *  These arrays are used in ML2194xx program
     ...
     D SL#             S              1    DIM(100)                             MLT STR MATCH LEV
...
¢C   C                   PARM                    ADDRTYPE          1            Address type M S
     ...
     C                   PARM                    A1#                            MLT SEC ADDR
     C                   PARM                    A2#                            MLT DEL ADDR
     C                   PARM                    NO#                            MLT STR NO
     C                   PARM                    PR#                            MLT PRE DIR
     C                   PARM                    NM#                            MLT NTR NAME
     C                   PARM                    SF#                            MLT STR SUFFIX
     C                   PARM                    PS#                            MLT POST DIR
     C                   PARM                    AT#                            MLT APT TYPE
     C                   PARM                    AN#                            MLT APT NUMBER
     C                   PARM                    CT#                            MLT CITY NAME
     C                   PARM                    CA#                            MLT CITY ABRV
     C                   PARM                    ST#                            MLT STATE CODE
     C                   PARM                    Z5#                            MLT ZIP CODE
     C                   PARM                    Z4#                            MLT ZIP+4
     C                   PARM                    LL#                            MLT LAST LINE
     C                   PARM                    CR#                            MLT CARRIER RTE
     C                   PARM                    DP#                            MLT DEL PT
     C                   PARM                    CO#                            MLT COUNTY NAME
     C                   PARM                    CS#                            MLT COUNTY STATE CD
     C                   PARM                    FS#                            MLT FIPS STATE #
     C                   PARM                    FC#                            MLT FIPS COUNTY #
     C                   PARM                    CD#                            MLT CONG DIST #
     C                   PARM                    LC#                            MLT LACS IND
     C                   PARM                    SL#                            MLT STR MATCH LEV
     C                   PARM                    AF#                            MLT SEC ADR FLAG
...
¢C   C                   PARM      *BLANKS       ECOD##82          3            ERROR CODE
     ...
     C                   MOVE      *BLANKS       A1#                            MLT SEC ADDR
     C                   MOVE      *BLANKS       A2#                            MLT DEL ADDR
     C                   MOVE      *BLANKS       NO#                            MLT STR NO
     C                   MOVE      *BLANKS       PR#                            MLT PRE DIR
     C                   MOVE      *BLANKS       NM#                            MLT NTR NAME
     C                   MOVE      *BLANKS       SF#                            MLT STR SUFFIX
     C                   MOVE      *BLANKS       PS#                            MLT POST DIR
     C                   MOVE      *BLANKS       AT#                            MLT APT TYPE
     C                   MOVE      *BLANKS       AN#                            MLT APT NUMBER
     C                   MOVE      *BLANKS       CT#                            MLT CITY NAME
     C                   MOVE      *BLANKS       CA#                            MLT CITY ABRV
     C                   MOVE      *BLANKS       ST#                            MLT STATE CODE
     C                   MOVE      *BLANKS       Z5#                            MLT ZIP CODE
     C                   MOVE      *BLANKS       Z4#                            MLT ZIP+4
     C                   MOVE      *BLANKS       LL#                            MLT LAST LINE
     C                   MOVE      *BLANKS       CR#                            MLT CARRIER RTE
     C                   MOVE      *BLANKS       DP#                            MLT DEL PT
     C                   MOVE      *BLANKS       CO#                            MLT COUNTY NAME
     C                   MOVE      *BLANKS       CS#                            MLT COUNTY STATE CD
     C                   MOVE      *BLANKS       FS#                            MLT FIPS STATE #
     C                   MOVE      *BLANKS       FC#                            MLT FIPS COUNTY #
     C                   MOVE      *BLANKS       CD#                            MLT CONG DIST #
     C                   MOVE      *BLANKS       LC#                            MLT LACS IND
     C                   MOVE      *BLANKS       SL#                            MLT STR MATCH LEV
     C                   MOVE      *BLANKS       AF#                            MLT SEC ADR FLAG
